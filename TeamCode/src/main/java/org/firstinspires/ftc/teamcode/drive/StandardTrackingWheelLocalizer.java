...
public class StandardTrackingWheelLocalizer extends ThreeTrackingWheelLocalizer {
    ...
    public static double LATERAL_DISTANCE = 14.63; // in; distance between the left and right wheels
    public static double FORWARD_OFFSET = -5.2; // in; offset of the lateral wheel
    public static double X_MULTIPLIER = 0.712;
    public static double Y_MULTIPLIER = 0.712;
